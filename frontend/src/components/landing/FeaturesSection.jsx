export default function FeaturesSection() {
  return (
    <section id="features" className="w-full max-w-7xl mx-auto py-16 px-4">
      <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
        <h2 className="text-xs font-bold uppercase tracking-widest text-emerald-600">
          High Performance Architecture
        </h2>
        <p className="font-serif text-3xl sm:text-4xl text-slate-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200/80 hover:border-emerald-500/40 hover:bg-emerald-50/30 transition-all duration-300 group">
          ...
          <h3 className="font-bold text-lg text-slate-900 mb-2">Custom Subdomains</h3>
          <p className="text-slate-600 text-sm leading-relaxed mb-4">
            Get your own branded address at <code className="text-emerald-700 bg-emerald-100/60 px-1.5 py-0.5 rounded font-mono text-xs">username.linkmakeup.com</code> with automated Cloudflare Workers routing.
          </p>
        ...
        <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200/80 hover:border-emerald-500/40 hover:bg-emerald-50/30 transition-all duration-300 group">
          <div className="w-12 h-12 rounded-2xl bg-slate-900 text-white flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <h3 className="font-bold text-lg text-slate-900 mb-2">Edge-Delivered Latency</h3>
          <p className="text-slate-600 text-sm leading-relaxed mb-4">
        ...
        <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200/80 hover:border-emerald-500/40 hover:bg-emerald-50/30 transition-all duration-300 group">
          ...
          <h3 className="font-bold text-lg text-slate-900 mb-2">Live Theme Studio</h3>
          <p className="text-slate-600 text-sm leading-relaxed mb-4">
