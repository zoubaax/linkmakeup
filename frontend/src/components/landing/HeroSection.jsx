...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto rounded-[28px] sm:rounded-[38px] md:rounded-[46px] border border-emerald-100/80 dark:border-emerald-900/40 overflow-hidden bg-gradient-to-b from-emerald-50/60 via-white to-emerald-50/30 dark:from-emerald-950/40 dark:via-zinc-900 dark:to-emerald-950/20 shadow-xl shadow-emerald-950/5 flex flex-col justify-center my-1 sm:my-3.5 py-18 sm:py-20 md:py-24">
      ...
      {/* Hero Content Container (Centered & Balanced) */}
      <div className="relative z-10 px-2 sm:px-10 md:px-16 flex flex-col items-center justify-center my-auto w-full text-center">
        <div className="flex flex-col items-center space-y-4 sm:space-y-6 md:space-y-7 max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-[18px] min-[360px]:text-[19.5px] min-[390px]:text-[21.5px] min-[420px]:text-[23.5px] sm:text-[36px] md:text-[44px] lg:text-[50px] xl:text-[54px] font-normal text-slate-900 dark:text-white leading-[1.25] sm:leading-[1.15] tracking-tight max-w-5xl">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base md:text-lg leading-relaxed max-w-xl mx-auto font-normal px-2 sm:px-0">
          ...
          {/* Trust Highlights */}
          <div className="flex flex-wrap items-center justify-center gap-x-4 sm:gap-x-7 gap-y-2 pt-2.5 sm:pt-4 text-xs text-slate-500 dark:text-slate-400">
