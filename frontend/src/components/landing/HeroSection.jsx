...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto rounded-[28px] sm:rounded-[44px] border border-emerald-100/80 overflow-hidden bg-gradient-to-b from-emerald-50/60 via-white to-emerald-50/30 shadow-xl shadow-emerald-950/5 flex flex-col justify-between my-2 sm:my-4 min-h-[60vh] sm:min-h-[72vh]">
      ...
      <div className="relative z-10 p-6 sm:p-14 md:p-20 flex flex-col items-center justify-center text-center my-auto w-full">
        ...
        <div className="space-y-4 sm:space-y-6 w-full max-w-5xl mx-auto text-center">
          
          {/* Headline - Responsive 2 lines */}
          <h1 className="font-serif text-3xl sm:text-6xl md:text-7xl font-normal text-slate-900 leading-[1.1] sm:leading-[1.08] tracking-tight max-w-4xl mx-auto">
          ...
          {/* Subtext */}
          <p className="text-slate-600 text-xs sm:text-base md:text-lg leading-relaxed max-w-xl mx-auto px-2">
          ...
          <div className="flex items-center justify-center pt-2 sm:pt-4">
            <button
              ...
              className="group flex items-center gap-2.5 sm:gap-3 p-1.5 sm:p-2 pr-5 sm:pr-6 rounded-2xl bg-slate-900 text-white hover:bg-black font-semibold text-xs sm:text-sm transition-all shadow-md hover:scale-105 active:scale-95"
            >
